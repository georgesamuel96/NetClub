 ...
 */
public class SocialskillsMotivationFragment extends Fragment implements CategoryPosts.View {
    ...
    public SocialskillsMotivationFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_socialskills_motivation, container, false);
